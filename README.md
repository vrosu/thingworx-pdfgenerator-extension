...
Please open issues [here](https://github.com/vrosu/thingworx-pdfgenerator-client-extension/issues) and feel free to fork it. Since it's not part of the PTC product suite, it is not supported by PTC Technical Support - please do not open Tech Support tickets for this extension.
